...
<html>
 ...
 <head>
  <title><?= $gui_welcome_title." > ".$gui_search_form_title." > ".$gui_search_send_title."."; ?></title>
 ...
 <body>
  ...
  <table cellspacing="0" cellpadding="0" class="bg_graphic" border="0" width="100%" summary="">
   <tbody>
    <tr>
     <td><b><?= $gui_search_send_header; ?></b></td>
    </tr>
    <tr>
     <td><?php d_s (1, 15); ?></td>
    </tr>
       ...
       <tbody>
        <tr>
         ...
         <td>
          ...
          ?>
          <br><br><?= $gui_you_can_go_to; ?>&nbsp;<a href="<?= FILENAME_WELCOME_PAGE; ?>"><b><?= $gui_go_to_index_page; ?></b></a> , <a href="<?= FILENAME_SEARCH_FORM; ?>"><b><?= $gui_go_back_txt; ?></b></a>.
         </td>
         <td><?php d_s (10, 1); ?></td>
        </tr>
       </tbody>
