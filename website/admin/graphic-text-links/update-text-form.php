...
<html>
 ...
 <body>
  <?php
   ...
   {
    // get this text link out of database.
    $link = get_text_link_details ($linkid);
   }
  ?>

  <!-- begin update text link form page -->
  ...
  <table cellspacing="0" cellpadding="0" border="0" summary="">
   <tbody>
    <tr>
     <td><b><?= $gui_admin_update_text_link_form_title; ?></b></td>
    </tr>
    <tr>
     <td><?php d_s (1, 15); ?></td>
    </tr>
    <tr>
     <td>
      <form method="post" name="update_text_form" action="<?= FILENAME_UPDATE_TEXT; ?>">
       <fieldset>
        <legend><?= $gui_admin_update_text_link_form_legend; ?></legend>
        <table cellpadding="0" cellspacing="0" border="0" summary="">
         <tbody>
          <tr>
           <td><?= $gui_admin_update_text_link_form_name; ?></td>
           <td><?php input_text ('name', 'width: 240px', clean_for_display ($link['text'])); ?></td>
          </tr>
          <tr>
           <td colspan="2"><?php d_s (1, 4); ?></td>
          </tr>
          <tr>
           <td><?= $gui_admin_update_text_link_form_description; ?></td>
           <td><?php input_text ('title', 'width: 240px', clean_for_display ($link['title'])); ?></td>
          </tr>
          <tr>
           <td colspan="2"><?php d_s (1, 4); ?></td>
          </tr>
          <tr>
           <td><?= $gui_admin_update_text_link_form_address; ?></td>
           <td>
            <table cellpadding="0" cellspacing="0" border="0" summary="">
             <tbody>
              <tr>
               <td colspan="2">
                <?php input_text ('url', 'width: 240px', clean_for_display ($link['url'])); ?>
               </td>
              </tr>
              <tr>
               <td><?php d_s (6, 1); ?></td>
  ...
  <!-- end update text link form page -->
 </body>
