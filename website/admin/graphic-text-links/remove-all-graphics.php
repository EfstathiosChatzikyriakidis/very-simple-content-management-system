...
<html>
 ...
 <body>
  <!-- begin remove all graphic links page -->
  <table cellspacing="0" cellpadding="0" border="0" width="100%" summary="">
   <tbody>
    <tr>
     <td><b><?= $gui_admin_remove_graphic_links_process; ?></b></td>
    </tr>
    <tr>
     <td><?php d_s (1, 15); ?></td>
    </tr>
    <tr>
     <td>
      <?
       // try to remove all the graphic links.
       remove_graphic_links ();
       echo '<br><br>';
  ...
  <!-- end remove all graphic links page -->
 </body>
