...
<html>
 ...
 <body>
  <!-- begin remove all page counters page -->
  <table cellspacing="0" cellpadding="0" border="0" width="100%" summary="">
   <tbody>
    <tr>
     <td><b><?= $gui_admin_remove_page_counters_process; ?></b></td>
    </tr>
    <tr>
     <td><?php d_s (1, 15); ?></td>
    </tr>
    <tr>
     <td>
      <?
       // try to remove all the page counters.
       remove_all_page_counters ();
       echo '<br><br>';
  ...
  <!-- end remove all page counters page -->
 </body>
